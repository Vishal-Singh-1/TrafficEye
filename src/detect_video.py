...
from sort import Sort  # from src/sort.py
...
# Input video from data folder
cap = cv2.VideoCapture(r"C:\Users\Vishal Singh\VS CODE folders\TrafficEye\data\traffic.mp4")

# Output video to output folder
fourcc = cv2.VideoWriter_fourcc(*'mp4v')
out = None  

# CSV logs in data folder
csv_file = open(
    r"C:\Users\Vishal Singh\VS CODE folders\TrafficEye\data\detections_log.csv",
    mode="w",
    newline=""
)
...
while cap.isOpened():
    ...
    if out is None:
        out = cv2.VideoWriter("../output/output.mp4", fourcc, 20.0, (w, h))
